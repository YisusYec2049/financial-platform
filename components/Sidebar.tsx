...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    viewBox: "0 0 24 24",
    icon: (
      <path fillRule="evenodd" clipRule="evenodd" d="M10.5 3.75a6.75 6.75 0 100 13.5 6.75 6.75 0 000-13.5zM2.25 10.5a8.25 8.25 0 1114.59 5.28l4.69 4.69a.75.75 0 11-1.06 1.06l-4.69-4.69A8.25 8.25 0 012.25 10.5zM10.5 7.5a.75.75 0 01.75.75v1.5h1.5a.75.75 0 010 1.5h-1.5v1.5a.75.75 0 01-1.5 0v-1.5h-1.5a.75.75 0 010-1.5h1.5v-1.5a.75.75 0 01.75-.75z" />
    ),
  },
  {
    href: "/excedentes",
    ...
    viewBox: "0 0 24 24",
    icon: (
      <path fillRule="evenodd" clipRule="evenodd" d="M12 2.25a.75.75 0 01.75.75v.756a10.5 10.5 0 018.494 8.494h.756a.75.75 0 010 1.5h-.756a10.5 10.5 0 01-8.494 8.494v.756a.75.75 0 01-1.5 0v-.756a10.5 10.5 0 01-8.494-8.494H2a.75.75 0 010-1.5h.756A10.5 10.5 0 0111.25 3.756V3a.75.75 0 01.75-.75zM12 6a6 6 0 100 12 6 6 0 000-12zm0 3a.75.75 0 01.75.75v1.5h1.5a.75.75 0 010 1.5h-1.5v1.5a.75.75 0 01-1.5 0v-1.5h-1.5a.75.75 0 010-1.5h1.5v-1.5A.75.75 0 0112 9z" />
    ),
  },
];
